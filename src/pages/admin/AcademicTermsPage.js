  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-slate-800">Academic Terms</h1>
        <button
      ...
      {formOpen && (
        <div className="mb-6 p-6 bg-white rounded-xl border border-slate-200">
          <h2 className="text-lg font-semibold text-slate-800 mb-4">
            {editingId ? "Edit Academic Term" : "New Academic Term"}
          </h2>
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        {loading ? (
          ...
          <div className="p-8 text-center text-slate-500">
            No academic terms yet. Click &quot;Add Academic Term&quot; to create
            one.
          </div>
        ) : (
